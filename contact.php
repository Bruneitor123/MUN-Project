        ...
        <div class="container-fluid bg-primary py-5 bg-bassmun" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 id="evento" class="display-4 text-white animated zoomIn">Contáctanos</h1>
                    <h5 class="h5 text-white animated zoomIn">Por acá puedes contactarnos, te ayudaremos en lo que necesites!</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                ...
                <h1 class="mb-0">Si tienes alguna pregunta, no dudes en hacerla.</h1>
            </div>
            <div class="row g-5 mb-5">
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.1s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Llama al Colegio Anglo Americano</h5>
                ...
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.4s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Envíanos un e-mail con tus dudas</h5>
                            <h4 class="text-primary mb-0">admin@pnu-aas.com</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="d-flex align-items-center wow fadeIn" data-wow-delay="0.8s">
                        ...
                        <div class="ps-4">
                            <h5 class="mb-2">Visita la oficina del Colegio</h5>
                            <h4 class="text-primary mb-0">Calle Baptista y Sucre S/N Oruro, Bolivia</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                    <form action="contacto_admin.php" method="POST">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <input type="text" class="form-control border-0 bg-light px-4" placeholder="Tu Nombre" name="name" style="height: 55px;" required>
                            </div>
                            <div class="col-md-6">
                                <input type="email" class="form-control border-0 bg-light px-4" placeholder="Tu Correo Electrónico" name="email" style="height: 55px;" required>
                            </div>
                            <div class="col-12">
                                <input type="text" class="form-control border-0 bg-light px-4" placeholder="Asunto" name="subject" style="height: 55px;" required>
                            </div>
                            <div class="col-12">
                                <textarea class="form-control border-0 bg-light px-4 py-3" rows="4" placeholder="Mensaje" name="message" required></textarea>
                            </div>
                            <div class="col-12">
                ...
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.6s">
                    ...
                    src="https://www.google.com/maps/embed/v1/place?q=Colegio+Anglo+Americano,+Oruro,+Bolivia&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8"
