        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Eventos</a>
                    <div class="dropdown-menu m-0">
        ...
        <div class="container-fluid bg-primary py-5 bg-bassmun" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-1 text-white animated zoomIn">Esto Es BassMUN</h1>
                    <div class="d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a class="h5 text-white">Colegio Anglo Americano / BassMUN 2k23</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <h1 class="mb-4">Hemos re-organizado BassMUN, esta vez, mucho mejor.</h1>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        <div class="section-title section-title-sm position-relative pb-3 mb-4">
                            <h3 class="mb-0">Conoce a Nuestro Staff</h3>
                        </div>
                        <div class="link-animated d-flex flex-column justify-content-start">
                            <label for="presi">Secretaria General:</label>
                            <a id="presi" class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"><i class="bi bi-arrow-right me-2"></i>Mariana Ailyn Villanueva Cortez</a>
                            <label for="presi">Sub-Secretaria General:</label>
                            <a id="mode" class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"><i class="bi bi-arrow-right me-2"></i>Belén Mejía Salinas</a>
                            <label for="presi">Coordinador de Logística y Tecnología:</label>
                            <a id="ofi_conf" class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"><i class="bi bi-arrow-right me-2"></i>Bruno Vincentty Viaña</a>
                            <label for="presi">Coordinadora de Asuntos Económicos:</label>
                            <a id="paje1" class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"><i class="bi bi-arrow-right me-2"></i>Georgina Grecia Medina Espinoza</a>
                            <label for="presi">Responsable de Comunicación y Marketing:</label>
                            <a id="paje2" class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"><i class="bi bi-arrow-right me-2"></i>Sara Sandy Toconaz</a>
                            <label for="presi">Responsable de Infraestructura y Soporte:</label>
                            <a id="paje2" class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"><i class="bi bi-arrow-right me-2"></i>Andrea Camila Villegas Ferrufino</a>
                            <label for="presi">Responsable de Prensa</label>
                            <a id="paje2" class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"><i class="bi bi-arrow-right me-2"></i>Rodrigo Martinez Romero</a>
                            <label for="presi">Asesora</label>
                            <a id="paje2" class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"><i class="bi bi-arrow-right me-2"></i>Ms. Elizabeth Mérida A. de Chacón</a>
                            <label for="presi">Asesora</label>
                            <a id="paje2" class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2"><i class="bi bi-arrow-right me-2"></i>Ms. Anita Bayá Hinojosa</a>
                        </div>
                    </div>
                    <!-- Category End -->
                </div>
