...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-item nav-link active" data-bs-toggle="dropdown">Blogs</a>
                    </div>
                    <div class="nav-item dropdown">
        ...
        <div class="container-fluid bg-primary py-5 bg-bassmun" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 id="evento" class="display-4 text-white animated zoomIn">El Rincón del Blog</h1>
                    <h5 class="h5 text-white animated zoomIn">En esta página encontrarás una entrada de todos los blogs que tenemos.</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="row g-5">
            <h4 id="Noticias-Importantes" class="mb-1"><strong>Noticias Importantes:</strong></h4>
                <!-- Blog list Start -->
                <div class="col-lg-8">
                    <div class="row g-5">
                        <div class="col-md-6 wow slideInUp" data-wow-delay="0.1s">
                            <div class="blog-item bg-light rounded overflow-hidden">
                                ...
                                <div class="p-4">
                                    ...
                                    <h4 class="mb-3">El Sitio Web del Programa de NN.UU. - A.A.S.</h4>
                        ...
                        <h4 id="convos-e-invis" class="mb-1"><strong>Convocatorias e Invitaciones:</strong></h4>
                        ...
                        <h4 id="Asesores" class="mb-1"><strong>Asesores:</strong></h4>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="#Noticias-Importantes"><i class="bi bi-arrow-right me-2"></i>Noticias Importantes</a>
                            <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="#convos-e-invis"><i class="bi bi-arrow-right me-2"></i>Convocatorias y Anuncios</a>
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        <div class="section-title section-title-sm position-relative pb-3 mb-4">
                            <h3 class="mb-0">Los Últimos Posts</h3>
                        </div>
                        <div class="d-flex rounded overflow-hidden mb-3">
                            <img class="img-fluid" src="img/convocatoria.png" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                            <a href="" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">Convocatoria BassMUN 2023
                            </a>
                        </div>
                        <div class="d-flex rounded overflow-hidden mb-3">
                            <img class="img-fluid" src="img/foro-abierto.png" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                            <a href="" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">El foro está abierto, ¿Existe alguna moción?
                            </a>
                        </div>
                        <div class="d-flex rounded overflow-hidden mb-3">
                            <img class="img-fluid" src="img/sitioweb.jpg" style="width: 100px; height: 100px; object-fit: cover;" alt="">
                            <a href="" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">El Sitio Web del Programa de NN.UU. - A.A.S.
                            </a>
                        </div>
                        <!-- <div class="d-flex rounded overflow-hidden mb-3">
